...
<form method="POST">
    ...
    <input class="form-control" id="Telefoonnummer" type="number" name="telefoonnummer" placeholder="Telefoonnummer">
    </div>
    <div class="form-group">
...
<!--    <input class="form-control" id="Arts" type="text" placeholder="Arts">-->
    ...
    <input class="form-control" id="verzekeringnummer" name="verzekeringnummer" type="text" placeholder="Verzekeringsnummmer">
    </div>
