...
<div class="row text-center">
    <div class="col-lg-2">
        <input class="form-control form-control-underlined border-danger" id="myInput" type="text"
               placeholder="Vul gegevens in">
    </div>
    <div class="col-lg-7">
    </div>
    <div class="col-lg-3">
    ...
    <table class="table table-striped">
        ...
        try {
            ...
            foreach ($result as &$data) {
                ...
                echo "<td><a href='overzicht/info.php?id=" . $data['id'] . "'>" . "<button type=\"button\" class=\"btn btn-info\">Info</button></a></td>";
                echo "</tr>";
