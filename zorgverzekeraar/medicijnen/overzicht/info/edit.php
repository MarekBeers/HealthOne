...
<form action="<?php echo "edit/update.php?id=".$data['id'] ?>" method="POST">
    <div class="form-group">
        ...
        <input  value="<?php echo $data['naam']; ?>" class="form-control" id="Naam" name="Naam" placeholder="Naam" required type="text">
    </div>
    <div class="form-group">
        <label for="Fabrikant">Fabrikant</label>
        <input value="<?php echo $data['fabrikant']; ?>" class="form-control" id="Fabrikant" name="Fabrikant" placeholder="Fabrikant" required type="text">
    </div>
    <div class="form-group">
        ...
        <select class="form-control" id="Vergoeding" name="Vergoeding">
            ...
            if ($data['vergoeding'] == 1){
                echo "<option>Vergoed</option>";
                echo "<option>Onvergoed</option>";
            }else{
    ...
    <div class="form-group">
        ...
        <input value="<?php echo $data['bijwerkingen']; ?>" class="form-control" id="Bijwerking" name="Bijwerking" placeholder="Bijwerking" required type="text">
    </div>
    <div class="form-group">
        <label for="Effect">Effect</label>
        <input value="<?php echo $data['effect']; ?>" class="form-control" id="Effect" name="Effect" placeholder="Effect" required type="text">
    </div>
    <div class="form-group">
